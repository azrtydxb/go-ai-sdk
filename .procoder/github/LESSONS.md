...
## 2026-08-20 procoder audit — changelog carried two heading styles at once

- Class: taste
- Missed by: linter
- Adaptation: `[docs] policy = "block"` in .procoder/config.toml, so the
  documentation obligation rides the commit gate rather than waiting for
