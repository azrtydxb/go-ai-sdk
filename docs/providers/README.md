...
| [OpenAI Codex](codex.md)        | OAuth credential (`codex.Credential`) or `WithCredentialSource`                        | `https://chatgpt.com/backend-api`                        | ChatGPT subscription `Authorization: Bearer`         |
